...
namespace ImGui {
    ...
    IMGUI_API bool IsNeoKeyframeLeftClicked();

    IMGUI_API void DeselectNeoTrack();

    IMGUI_API bool IsNeoTimelineRightClicked();
    IMGUI_API bool IsNeoTimelineLeftClicked();

    IMGUI_API bool IsNeoGroupRightClicked();
    IMGUI_API bool IsNeoGroupLeftClicked();

    IMGUI_API ImGuiID GetNeoLastTimeline();
    IMGUI_API ImGuiID GetNeoThisTimeline();
